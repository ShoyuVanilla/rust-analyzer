...
use crate::{
    ...
    CallableDefId, Const, ConstScalar, InferenceResult, Interner, MemoryMap, Substitution,
...
use hir_def::{
    ...
    ClosureId, DefWithBodyId, FieldId, StaticId, TupleFieldId, UnionId, VariantId,
};
