...
use hir_def::{
    ...
    AdtId, ClosureId, ClosureLoc, DefWithBodyId, EnumVariantId, FunctionId, HasModule,
...
use crate::{
    ...
    CallableDefId, ComplexMemoryMap, Const, ConstData, ConstScalar, FnDefId, Interner, MemoryMap,
...
impl Evaluator<'_> {
    ...
    fn exec_fn_pointer(
        ...
        match next_ty.kind(Interner) {
            ...
            TyKind::Closure(id, subst) => self.exec_closure(
                from_chalk_closure_id(*id),
                bytes.slice(0..0),
                subst,
                destination,
                args,
