...
use crate::{
    ...
    mir::eval::{
        ...
        Interner, Interval, IntervalAndTy, IntervalOrOwned, ItemContainerId, LangItem, Layout,
        Locals, Lookup, MirEvalError, MirSpan, Mutability, Result, Substitution, Ty, TyBuilder,
        TyExt,
    },
    DropGlue,
};
    ...
    fn exec_clone(
        ...
        match self_ty.kind(Interner) {
            ...
            TyKind::Closure(id, subst) => {
                ...
                let ClosureLoc { parent: closure_owner, .. } =
                    self.db.lookup_intern_closure_def(id);
